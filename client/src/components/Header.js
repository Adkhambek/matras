...
const Header = () => {
    ...
    const nameReq = () => {
        axios.get(API + "/api/products/name").then((res) => {
        ...
        <>
                ...
                <div className="container">
                    <div className="menu">
                        <div className="d-flex justify-content-end linkss">
                            <ul>
                                <li>
                                    <a href="#products">Matraslar</a>
                                </li>
                                <li>
                                    <a href="#action">Aksiya</a>
                                </li>
                                <li>
                        ...
                        <div className="nuumber">
                            <div className="d-flex   align-items-center  phone-div">
                                ...
                                <a
                                    ...
                                    href="tel:[phone number]"
                                >
                                    <h6 className="mb-0">+998 78 122 02 03</h6>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <Modal open={open} onClose={onCloseModal} center>
                <div className="modal-body">
                    ...
                    <form onSubmit={submit} action="">
                        <input
                            minLength={4}
                            title="Faqat harf bilan kiriting va 4ta harfdan kam bo'lmasin"
                            pattern="[a-zA-Z'-'\s]*"
                        ...
                        <div
                            ...
                            className="d-flex align-items-center justify-content-start phone"
                        >
                            <div>+998</div>
                            <input
                                style={{
                        ...
                        <label style={{ marginTop: "45px" }} htmlFor="">
                            Mahsulotni tanlang
                        </label>
                        <select
                            className="form-control"
                        ...
                        <label style={{ marginTop: "25px" }} htmlFor="">
                            Miqdorni tanlang
                        </label>
            ...
            <Modal open={openSecond} onClose={onCloseModalSecond} center>
                <div className="text-center">
                    <h1 className="mt-5">
                        Arizangiz muvaffaqiyatli <br /> yuborildi
                    </h1>
                    <img src="/assets/ariza.png" alt="" />
                    <p>{connect}</p>
                    <button onClick={onCloseModalSecond} className="w-100">
                        Ok
                    </button>
                </div>
            </Modal>
            <Modal open={phone} onClose={onClosePhone} center>
                <div
                    ...
                    className="d-flex   align-items-center  phone-div"
                >
                    <img src="/assets/call.png" alt="" />
                    <a
                        style={{
                ...
                >
                    ...
                    <a
                        ...
                        href="tel:[phone number]"
                    >
                        <h6 className="mb-0">+998 90 931 47 47</h6>
                    </a>
                </div>
                <div>
                    <h6
