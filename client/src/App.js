            ...
            <div style={{height:"80vh",display:'flex',alignItems:"center",justifyContent:"center"}}>
             ...
             <BrowserRouter>
                 <Switch>
                     ...
                     {localStorage.getItem('Mydata')?<Route path="/admin" exact component={Admin}/>:<Redirect to={"/admin"}/>}
                    
 
 
                     <Route path="/dashboard/banners" exact component={Banners}/>
                     <Route path="/dashboard/categories" exact component={Categories}/>
                     <Route path="/dashboard/location" exact component={Locationn}/>
                     <Route path="/dashboard/orders/:id" exact component={Orders}/>
                     <Route path="/dashboard/products" exact component={Products}/>
                     <Route path="/dashboard/technology" exact component={Technology}/>
                     <Route path="/dashboard/customers/:id" exact component={Customers}/>
                     <Route path="/dashboard/stats" exact component={StatisticsDashboard}/>
                 </Switch>
             </BrowserRouter>
             <ToastContainer/>
         </>
